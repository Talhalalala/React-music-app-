...
const PUBLIC_DIRECTORY = path.join(ROOT_DIRECTORY, './music-app/public'); // the root of the frontend, i.e. html file

const config = {
  entry: [path.resolve(ROOT_DIRECTORY, './music-app/src/index.js')], // the main JavaScript file of the project
  output: {
